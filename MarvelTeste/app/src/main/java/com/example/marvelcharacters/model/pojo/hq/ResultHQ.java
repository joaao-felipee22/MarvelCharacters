...
public class ResultHQ implements Parcelable {
    ...
    public static final Creator<ResultHQ> CREATOR = new Creator<ResultHQ>() {
        @Override
        public ResultHQ createFromParcel(Parcel in) {
            return new ResultHQ(in);
        }

        @Override
        public ResultHQ[] newArray(int size) {
            return new ResultHQ[size];
        }
    };
